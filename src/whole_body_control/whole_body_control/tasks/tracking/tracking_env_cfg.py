...
import whole_body_control.tasks.tracking.mdp as mdp
from whole_body_control.assets.robots.vita_boy import VITA_BOY_ACTION_SCALE
...
class ActionsCfg:
    ...
    JointPositionAction = mdp.JointPositionActionCfg(
        asset_name="robot", joint_names=[".*"], scale=VITA_BOY_ACTION_SCALE, use_default_offset=True
    )
...
class RewardsCfg:
    ...
    # -- base
    joint_acc = RewTerm(func=mdp.joint_acc_l2, weight=-4e-7)
    torque_limits = RewTerm(func=mdp.applied_torque_limits, weight=-0.3)
...
class TrackingPlayEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        super().__post_init__()
