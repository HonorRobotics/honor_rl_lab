...
From the `honor_rl_lab` root, activate the project environment and install the
extension if needed:
...
LOCO and TRACKING joint arrays use policy order; `joint2motor_idx` maps each
policy joint to the MuJoCo motor index.
